...
output1 <- Args[3] # I2_GX
output2 <- Args[4] # SIMEX_Intercept
output3 <- Args[5] # SIMEX_Slope
...
write.table(re3[1,],output2,quote=F,row.names=F,col.names=F,sep="\t") # SIMEX_Intercept
write.table(re3[2,],output3,quote=F,row.names=F,col.names=F,sep="\t") # SIMEX_Slope
